...
renamed as (
    ...
    select
        ...
        tournament_id,
        match_id,
        json_extract_string(a83, '$[0].a86') as player1_id,
        json_extract_string(a84, '$[0].a86') as player2_id,
        a81 as point_id,

        nullif(a13, 'NA') as server_id,
        nullif(a14, 'NA') as scorer_id,
        nullif(a15, 'NA') as receiver_id,
